...
@st.cache_resource
def get_model():
    #tokenizer = AutoTokenizer.from_pretrained("/Users/xfliu/Desktop/chatglm2-6b", trust_remote_code=True)
    tokenizer = ''
    #model = AutoModel.from_pretrained("/Users/xfliu/Desktop/chatglm2-6b", trust_remote_code=True).cuda()
    model = ''
